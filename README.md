...
[![Version](https://img.shields.io/badge/version-0.2.4--beta-yellow.svg)](https://github.com/msncakma/WardenIPS)
...
WardenIPS v0.2.4-beta is feature-complete for its intended scope, with professional CLI tooling and robust error handling.

- Current state: **v0.2.4-beta** — beta release for active stabilization before the next formal stable tag.
