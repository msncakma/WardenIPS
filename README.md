...
[![Version](https://img.shields.io/badge/version-0.3.0--beta.6-green.svg)](https://github.com/msncakma/WardenIPS)
...
WardenIPS v0.3.0-beta-7 is feature-complete for its intended scope, with professional CLI tooling and robust error handling.

- Current state: **v0.3.0-beta-7** — active beta line with Debian-only packaging and release pipeline.
