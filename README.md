...
WardenIPS v0.3.0-beta-8 is feature-complete for its intended scope, with professional CLI tooling and robust error handling.

- Current state: **v0.3.0-beta-8** — active beta line with Debian-only packaging and release pipeline.
