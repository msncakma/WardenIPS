...
WardenIPS v0.2.7-beta-3 is feature-complete for its intended scope, with professional CLI tooling and robust error handling.

- Current state: **v0.2.7-beta-3** — active beta line with Debian-only packaging and release pipeline.
